...
//   const productsPerPage = 6; // per page kitne products dikhane hain
...
//     { id: 4, name: "Bright Gold Purse", category: "Accessories", price: 1600, image: "/17.jpg" },
...
//     { id: 12, name: "Black HandBag", category: "Women", price: 2000, image: "/14.jpg" },
//     { id: 13, name: "Golden Purse", category: "Accessories", price: 2200, image: "/17.jpg" },
//     { id: 14, name: "Winter Coat", category: "Men", price: 2500, image: "/16.jpg" },
//   ];
...
//   return (
//     <div className="bg-[#f5f7f9] py-20 px-5">
...
//                 <p className="text-[#0084d6] font-bold">₨ {product.price}</p>
//                 <button
//                   onClick={() => addToCart(product)}
//                   className="mt-3 bg-[#0084d6] text-white px-5 py-2 rounded hover:bg-[#0070b3]"
//                 >
//                   Add to Cart
//                 </button>
//               </div>

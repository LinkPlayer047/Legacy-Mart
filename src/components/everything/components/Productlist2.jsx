          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="relative w-full h-64">
                <img src="/3.jpg" alt="" className="object-cover" />
              </div>
              <div className="p-4 text-center">
                <h3 className="text-[16px] font-semibold text-gray-800 mb-2">
                  Dark Brown Jeans
                </h3>
                <p className="text-gray-500 mb-2">Men</p>
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="relative w-full h-64">
                <img src="/15.jpg" alt="" className="object-cover" />
              </div>
              <div className="p-4 text-center">
                <h3 className="text-[16px] font-semibold text-gray-800 mb-2">
                  Blue Denim Jeans
                </h3>
                <p className="text-gray-500 mb-2">Women</p>
                <h4 className="text-[#0084d6] font-bold text-[18px] mb-3">
                  ₨ 1,200
                </h4>
                <button className="bg-[#0084d6] text-white px-5 py-2 rounded hover:bg-[#0070b3] transition">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="relative w-full h-64">
                <img src="/16.jpg" alt="" className="object-cover" />
              </div>
              <div className="p-4 text-center">
                <h3 className="text-[16px] font-semibold text-gray-800 mb-2">
                  Blue Hoodie
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="relative w-full h-64">
                <img src="/10.jpg" alt="" className="object-cover" />
              </div>
              <div className="p-4 text-center">
                <h3 className="text-[16px] font-semibold text-gray-800 mb-2">
                  Bright Red Bag
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="relative w-full h-64">
                <img src="/13.jpg" alt="" className="object-cover" />
              </div>
              <div className="p-4 text-center">
                <h3 className="text-[16px] font-semibold text-gray-800 mb-2">
                  Black Hoodie
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="relative w-full h-64">
                <img src="/14.jpg" alt="" className="object-cover" />
              </div>
              <div className="p-4 text-center">
                <h3 className="text-[16px] font-semibold text-gray-800 mb-2">

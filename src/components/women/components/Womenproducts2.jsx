...
const Womenproducts2 = () => {
  ...
  // -------------------------
  const products = [
    { id: 1, name: "Blue Denim Jeans", category: "Women", price: 1200, image: "/15.jpg" },
    { id: 2, name: "Light Brown Purse", category: "Women", price: 2000, image: "/9.jpg" },
    { id: 3, name: "Bright Red Bag", category: "Women", price: 2000, image: "/10.jpg" },
    { id: 4, name: "Black Over The Shoulder HandBag", category: "Women", price: 2000, image: "/14.jpg" },

    ...
    >
      <div className="mycontainer relative h-[450px] flex flex-col items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 px-5">
          ...
          <p className="max-w-2xl mx-auto mb-5 text-sm md:text-base">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
            tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.
          </p>
          <h3 className="text-base md:text-lg font-medium mb-6">
            Buy This T-shirt At{" "}
            <span className="text-white">20% Discount, Use Code OFF20</span>
          </h3>
          <button className="bg-white text-black text-sm font-semibold py-3 px-7 uppercase hover:bg-black hover:text-white transition">
            Shop Now
          </button>
        </div>
      </div>
